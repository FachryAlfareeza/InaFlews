...
import { Map, Bell, ChartBar as BarChart3, Cpu, Layers, Cloud, Mountain, Shield, TriangleAlert as AlertTriangle, CircleCheck as CheckCircle2, Wifi, Satellite, Radio, Activity } from 'lucide-react';
...
export default function LeftSidebar({ activeTab, onTabChange, layers, onLayerToggle }: LeftSidebarProps) {
  return (
    <div className="w-64 flex-shrink-0 bg-[#060c1a] border-r border-slate-700/40 flex flex-col overflow-hidden">
      {/* Logo / Header */}
        ...
        {activeTab === 'map' && (
          <div className="p-3">
            ...
            <div className="mt-4">
              ...
              {[
                { color: 'bg-red-500', label: 'Critical (>0.7)', opacity: 'opacity-100' },
                { color: 'bg-yellow-500', label: 'Elevated (0.4–0.7)', opacity: 'opacity-80' },
                { color: 'bg-green-500', label: 'Low (<0.4)', opacity: 'opacity-60' },
              ].map(({ color, label }) => (
